...
let Collections = () => {
    return <div className={css.outerDiv}>
        ...
        <div className={css.tagLine}>
            <span className={css.desc}>Explore curated lists of top restaurants, cafes, pubs, and bars in Al-Barsha, based on trends</span>
            <span className={css.collectionPlacesTag}>All collections in Al-Barsha <span className={css.rightArrowBox}><img className={css.rightArrow} src={rightArrow} alt="right arrow" /></span></span>
        </div>
