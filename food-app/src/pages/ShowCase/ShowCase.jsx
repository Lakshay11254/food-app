        ...
        <div className={css.innerDiv6}>
            <div className={css.w7}>
                <div className={css.innerDiv6Title}>
                    {page === orderOnlinePage ? "Delivery Restaurants in Al-Barsha" : page === diningOutPage ? "Dine-Out Restaurants in Dubai" : "Nightlife Restaurants in Dubai"}
                </div>
